...
object processor_main {
  ...
  def main(args: Array[String]){
    ...
    while (lc==0) {
      ...
      var imm_SB: Int = (((instr >> 31) & 0x1) << 12) + (((instr >> 7) & 0x1) << 11) + (((instr >> 25) & 0x3f) << 5) + ((instr >> 8) & 0xf)
      var imm_U: Int = (instr >> 12) & 0xfffff
      var imm_UJ: Int = (((instr >> 31) & 0x1) << 20) + (((instr >> 12) & 0xff) << 12) + (((instr >> 20) & 0x1) << 11) + ((instr >> 21) & 0x3ff) // er usikker på denne her skal testes
      ...
      opcode match {
        ...
        case 0x37 => reg(rd) = imm_U //LUI
        case 0x17 => pc = pc + imm_U //AUIPC
